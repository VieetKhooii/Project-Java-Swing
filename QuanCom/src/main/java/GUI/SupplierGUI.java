...
//                phoneNumbTxt.setText(detailTableModel.getValueAt(row, 3).toString());
        ...
        addSupplierBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                else if(nameSupplierTxt.getText().equals("") || addressSupplierTxt.getText().equals("")) {
                    JOptionPane.showMessageDialog(null, "Thông tin chưa đầy đủ!", "Thông báo", JOptionPane.WARNING_MESSAGE);
                }
                else {
                    supplierService.addSupplier(nameSupplierTxt.getText(),addressSupplierTxt.getText());
                    showTableSupplier();
        ...
        fixSupplierBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (idSupplierTxt.getText().equals("")){
                    ...
                    supplierService.supplierModify(Integer.parseInt(idSupplierTxt.getText()),nameSupplierTxt.getText(),addressSupplierTxt.getText());
                    showTableSupplier();
